...
$attrs = [
	'class'      => [
		...
		'fl-button-group-layout-' . $settings->layout,
		'fl-button-group-width-' . $settings->width,
	],
	'role'       => 'group',
	'aria-label' => esc_attr( $settings->button_group_label ),
];
...
<div <?php $module->render_attributes( $attrs ); ?>>
	...
	for ( $i = 0; $i < count( $settings->items ); $i++ ) :
		...
		$button_settings = array(
			...
			'icon_extra'            => isset( $settings->items[ $i ]->icon_extra ) ? $settings->items[ $i ]->icon_extra : '',
