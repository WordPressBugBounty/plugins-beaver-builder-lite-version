<?php
class FLBuilderConfig {

	/**
	 * Get the full filtered config array
	 * @return Array
	 */
	...
	/**
	 * Get the filtered strings array
	 *
	 * @return Array
	 */
	static public function get_strings() {
		$strings = [
			...
			'deleteDynamicTemplate'          => esc_attr__( 'WARNING! You are about to delete a component that may be linked to other pages. Do you really want to delete this component and unlink it?', 'fl-builder' ),
			...
			'componentBadge'                 => esc_attr_x( 'Component', 'Indicator for dynamic global node templates.', 'fl-builder' ),
			'disableComponentEditing'        => esc_attr__( 'Disable Component Editing', 'fl-builder' ),
			'enableComponentEditing'         => esc_attr__( 'Enable Component Editing', 'fl-builder' ),
			...
			'unlinkDynamicWarning'           => esc_attr__( 'Are you sure you want to unlink this component?', 'fl-builder' ),
			'unlinkTemplateWarning'          => esc_attr__( 'Are you sure you want to unlink this template?', 'fl-builder' ),
			'yesPlease'                      => esc_attr__( 'Yes Please!', 'fl-builder' ),
			// translators: %s : HTML link
			'dynamicNodeEmpty'               => sprintf( esc_attr__( 'No editable settings are defined for this component. To allow editing, add settings in the main instance. %s', 'fl-builder' ), sprintf( '<a href="TEMPLATE_URL" class="fl-dynamic-node-edit-link">%s &rarr; </a>', esc_attr__( 'Add Settings', 'fl-builder' ) ) ),
			'makeFieldDynamic'               => esc_attr__( 'Enable Component Editing', 'fl-builder' ),
			...
			'i18n'                           => array(
				...
				'Type'                   => esc_attr__( 'Type', 'fl-builder' ),
				'Angle'                  => esc_attr__( 'Angle', 'fl-builder' ),
				'Distribute color spots' => esc_attr__( 'Distribute color spots', 'fl-builder' ),
				'Select Color Stop'      => esc_attr__( 'Select Color Stop', 'fl-builder' ),
	...
	/**
	 * Get JSON representation of the config array
	 *
	 * @return String
	 */
	static public function get_json() {
		return FLBuilderUtils::json_encode( self::get() );
	}

	/**
	 * Get JSON representation of the strings array
	 *
	 * @return String
	 */
	static public function get_strings_json() {
		return FLBuilderUtils::json_encode( self::get_strings() );
	}
}
